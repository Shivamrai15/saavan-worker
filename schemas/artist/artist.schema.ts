...
import { AlbumAPISchema, AlbumSchema } from '../album';


export const ArtistAPISchema= z.object({
    artistId: z.string(),
    name: z.string(),
    subtitle: z.string(),
    image: z.string(),
    ...
    topSongs: z.array(SongAPISchema),
    topAlbums: z.array(AlbumAPISchema),
    singles: z.array(SongAPISchema),
