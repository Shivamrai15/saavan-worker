...
export const createSearchPayload = (search: z.infer<typeof SearchAPISchema>): z.infer<typeof SearchSchema> => ({
    topQuery: {
...
export const createSearchPlaylistPayload = (
    playlist: z.infer<typeof SearchPlaylistAPISchema>
): z.infer<typeof SearchPlaylistSchema> => ({
...
export const createSearchAlbumPayload = (
    album: z.infer<typeof SearchAlbumAPISchema>
): z.infer<typeof SearchAlbumSchema> => ({
