...
import { ArtistAlbumSchema, ArtistSchema, ArtistSongSchema } from '../../schemas/artist';
        ...
        createRoute({
            ...
            query: z.object({
                ...
                .openapi({
                    ...
                    type: 'string',
                    example: 'https://www.jiosaavn.com/artist/arijit-singh-songs/LlRWpHzy3Hk_'
                }),
        ...
        createRoute({
            ...
            200: {
                ...
                'application/json': {
                    ...
                    data: ArtistAlbumSchema.openapi({
